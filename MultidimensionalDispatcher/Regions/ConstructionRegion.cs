...
public sealed class ConstructionRegion : Region
{
    public ConstructionRegion(VersionState versionState, ObjectState objectState) : base(versionState, objectState)
    {
    }
